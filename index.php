...
<html>
    ...
    <style type="text/css">
        *
        ...
        .container-fluid
        {
            width: 100%;
            height: 100vh;
            background: linear-gradient(to left, rgba(0,0,0,0.5)50%, rgba(0,0,0,0.5)50%), url(Pets01-22.jpg);
    ...
    <body>
        <div class="container-fluid">
            <div class="container">
                <h2>Pet Hive Clinic</h2>
                <ul>
                    <li><a href="https://www.facebook.com/beatricejoyce.malonzo">HOME</a></li>
                    <li><a href="https://www.facebook.com/Pethiveofficial">ABOUT US</a></li>
